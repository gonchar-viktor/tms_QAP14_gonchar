...
# добавил особенности в класс к каждому цветку
# счётчик цветов обернул в функцию
# проверку на то, есть ли цветок в букете обернул в функцию
# сортировку цветов по стоимости обернул в функцию
# определение времени увядания букета обернул в функцию
# сбор букета с определением стоимости обернул в функцию
# добавил аксессуар "ленточка"
